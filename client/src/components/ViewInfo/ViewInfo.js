...
class ViewInfo extends React.Component {
  ...
  componentDidMount() {
    this.url = `${baseURL}/api/${this.props.type}/${this.props.id}`;
  ...
  render() {
    ...
    if (this.state.error) {
      ...
      const errorMsg =
        "Could not retrieve data! Please reload the page and try again.";
      return (
